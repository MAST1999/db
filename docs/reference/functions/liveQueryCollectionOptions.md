...
Defined in: [packages/db/src/query/live-query-collection.ts:62](https://github.com/MAST1999/db/blob/main/packages/db/src/query/live-query-collection.ts#L62)
